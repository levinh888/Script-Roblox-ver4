...
local enemyTags = {}
local pvpFunctions = {
	{ name = "Hitbox (Tool / Người)", var = "hitboxEnabled" },
	{ name = "Speed CFrame", var = "speedEnabled" },
	{ name = "Tự Đánh (Tool)", var = "autoAttack" },
	{ name = "Xoá Tường", var = "wallRemoved" },
	{ name = "Hiện Địch + Tên", var = "enemyMarkers" },
	{ name = "Spin Nhân Vật", var = "spinEnabled" },
	{ name = "Tốc độ Vung Tool", var = "swingSpeed" },
	{ name = "Hiển thị Máu Kẻ Địch", var = "enemyHP" }
}
